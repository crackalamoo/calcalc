...
var language2 = getLocalItem("language2", "en");
var language3 = getLocalItem("language3", "en");
var language4 = getLocalItem("language4", "en");
var language5 = getLocalItem("language5", "en");
//var language6 = getLocalItem("language6", "zh");
var dst = getLocalItem("dst", "none");
var theme = getLocalItem("theme", "");

var coordinates = [
  getLocalItem("lat", "37 34 31"),
  getLocalItem("NS", 0),
  getLocalItem("long", "122 20 31"),
  getLocalItem("EW", 1)
];
var hinduSettings = [
